...
namespace CricketStructures.Statistics.Implementation.Player.Career
{
    internal class MostClubRuns : ICricketStat
    {
        ...
        public void ExportStats(ReportBuilder rb, DocumentElement headerElement)
        {
            ...
            _ = rb.WriteTitle("Most Club Runs", headerElement)
                .WriteTableFromEnumerable(new string[] { "Name", "StartDate", "EndDate", "Runs Scored" }, export.Select(value => new string[] { value.Name.ToString(), value.Start.ToShortDateString(), value.End.ToShortDateString(), value.Value.ToString() }), headerFirstColumn: false);
        }
